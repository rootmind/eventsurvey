...
//  Onboard
//
//  Created by Sai Kiran Gandham on 9/23/15.
//  Copyright © 2015 Sai Kiran Gandham. All rights reserved.
//

#import <UIKit/UIKit.h>
#import <QuartzCore/QuartzCore.h>
#import "ACPortfolioViewController.h"
...
#import "LoanPortfolioViewController.h"
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title=@"Customer Portfolio";
...
//    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:tableView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:screenView attribute:NSLayoutAttributeWidth multiplier:1.0 constant:0]];
    ...
    [btnAccount setImage:[[UIImage imageNamed:@"user.png" ] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
    [btnAccount.titleLabel   setFont:[UIFont fontWithName:@"HelveticaNeue" size:25]];
    ...
    btnAccount.backgroundColor = [UIColor strongCeruleanColor];
...
//    //---btnAccount UIView
//    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnAccount attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationLessThanOrEqual toItem:self.view attribute:NSLayoutAttributeCenterY multiplier:1.0 constant:0]];
//
...
//
//    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnAccount attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeWidth multiplier:0.25 constant:0]];
    
    
    //---btnAccount UIView
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnAccount attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationLessThanOrEqual toItem:self.view attribute:NSLayoutAttributeCenterY multiplier:0.9 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnAccount attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterX multiplier:1.5 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnAccount attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeHeight multiplier:0.09 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnAccount attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeWidth multiplier:0.25 constant:0]];
    
    
    UIButton *btnFixedDeposit = [[UIButton alloc] init];
    [btnFixedDeposit setTitle:@"Fixed Deposit" forState:UIControlStateNormal];
    [btnFixedDeposit setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [btnFixedDeposit setImage:[[UIImage imageNamed:@"user.png" ] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
    [btnFixedDeposit.titleLabel   setFont:[UIFont fontWithName:@"HelveticaNeue" size:25]];
    //btnFixedDeposit.titleLabel.font = [UIFont systemFontOfSize:20];
    btnFixedDeposit.layer.borderWidth=1.0;
    btnFixedDeposit.layer.borderColor=[UIColor whiteColor].CGColor;
    btnFixedDeposit.backgroundColor = [UIColor strongCeruleanColor];
    btnFixedDeposit.layer.shadowOffset = CGSizeMake(0, 3);
    btnFixedDeposit.layer.shadowRadius = 10.0;
    btnFixedDeposit.layer.shadowColor = [UIColor blackColor].CGColor;
    btnFixedDeposit.layer.shadowOpacity = 0.8;
    btnFixedDeposit.layer.cornerRadius = 15.0;
    [btnFixedDeposit addTarget:self action:@selector(viewFixedDeposit) forControlEvents:UIControlEventTouchUpInside];
    btnFixedDeposit.translatesAutoresizingMaskIntoConstraints=NO;
    [self.view addSubview:btnFixedDeposit];
    
    //---btnFixedDeposit UIView
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnFixedDeposit attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationLessThanOrEqual toItem:self.view attribute:NSLayoutAttributeCenterY multiplier:1.15 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnFixedDeposit attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterX multiplier:1.5 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnFixedDeposit attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeHeight multiplier:0.09 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnFixedDeposit attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeWidth multiplier:0.25 constant:0]];
    
    
    
    UIButton *btnLoans = [[UIButton alloc] init];
    [btnLoans setTitle:@"Loans" forState:UIControlStateNormal];
    [btnLoans setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [btnLoans setImage:[[UIImage imageNamed:@"user.png" ] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
    [btnLoans.titleLabel   setFont:[UIFont fontWithName:@"HelveticaNeue" size:25]];
    //btnLoans.titleLabel.font = [UIFont systemFontOfSize:20];
    btnLoans.layer.borderWidth=1.0;
    btnLoans.layer.borderColor=[UIColor whiteColor].CGColor;
    btnLoans.backgroundColor = [UIColor strongCeruleanColor];
    btnLoans.layer.shadowOffset = CGSizeMake(0, 3);
    btnLoans.layer.shadowRadius = 10.0;
    btnLoans.layer.shadowColor = [UIColor blackColor].CGColor;
    btnLoans.layer.shadowOpacity = 0.8;
    btnLoans.layer.cornerRadius = 15.0;
    [btnLoans addTarget:self action:@selector(viewLoans) forControlEvents:UIControlEventTouchUpInside];
    btnLoans.translatesAutoresizingMaskIntoConstraints=NO;
    [self.view addSubview:btnLoans];
    
    //---btnLoans UIView
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnLoans attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationLessThanOrEqual toItem:self.view attribute:NSLayoutAttributeCenterY multiplier:1.4 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnLoans attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterX multiplier:1.5 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnLoans attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeHeight multiplier:0.09 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnLoans attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeWidth multiplier:0.25 constant:0]];
    ...
    [btnCreditCard setImage:[[UIImage imageNamed:@"user.png" ] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
    [btnCreditCard.titleLabel   setFont:[UIFont fontWithName:@"HelveticaNeue" size:25]];
    ...
    btnCreditCard.backgroundColor = [UIColor strongCeruleanColor];
    ...
    //---btnCreditCard UIView
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnCreditCard attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationLessThanOrEqual toItem:self.view attribute:NSLayoutAttributeCenterY multiplier:1.65 constant:0]];
    ...
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnCreditCard attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeHeight multiplier:0.09 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:btnCreditCard attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeWidth multiplier:0.25 constant:0]];
...
//    {
        ...
        accountTrnViewController.cifNumber=accountsData.cifNumber;
        accountTrnViewController.accountNumber=accountsData.accountNumber;
...
//        [self parseResponseSpendData:newData:@"fetchSpendData":@"spendDataWrapper"];
        ...
        newData=[CommonUtils connectHost :@"fetchAccounts" :jsonDictionary:self];
        [self parseResponseFetchAccounts:newData:@"fetchAccounts":@"accountsWrapper"];
...
-(void)displayGraph
{
    ...
    NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"portfolio" ofType:@"html" inDirectory:@"www"]];
    ...
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:dashboardWebView attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterY multiplier:1.5 constant:0]];
    ...
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:dashboardWebView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeWidth multiplier:0.4 constant:0]];
...
-(void)viewAccounts
{
    ...
    ACPortfolioViewController *acPortfolioViewController = [[ACPortfolioViewController alloc]initWithNibName:nil bundle:nil];
    
    //NSLog(@"selected account %@",[self.onBoardDataValueData objectAtIndex:indexPath.row]);
    
    acPortfolioViewController.cifNumber=self.cifNumber;
    acPortfolioViewController.accountNumber=self.accountNumber;
    //acPortfolioViewController.accountType=@"SAVINGS";
    
    acPortfolioViewController.accountType=@"CASA";
    
    [self.navigationController pushViewController:acPortfolioViewController animated:YES];
...
-(void)viewLoans
{
    ...
    LoanPortfolioViewController *loanPortfolioViewController = [[LoanPortfolioViewController alloc]initWithNibName:nil bundle:nil];
    
    //NSLog(@"selected account %@",[self.onBoardDataValueData objectAtIndex:indexPath.row]);
    
    loanPortfolioViewController.cifNumber=self.cifNumber;
    loanPortfolioViewController.accountNumber=self.accountNumber;
    loanPortfolioViewController.accountType=@"LOANS";
    
    [self.navigationController pushViewController:loanPortfolioViewController animated:YES];
    
}


-(void)viewFixedDeposit
{
    
    FDPortfolioViewController *fdPortfolioViewController = [[FDPortfolioViewController alloc]initWithNibName:nil bundle:nil];
    
    //NSLog(@"selected account %@",[self.onBoardDataValueData objectAtIndex:indexPath.row]);
    
    fdPortfolioViewController.cifNumber=self.cifNumber;
    fdPortfolioViewController.accountNumber=self.accountNumber;
    fdPortfolioViewController.accountType=@"DEPOSIT";
    
    [self.navigationController pushViewController:fdPortfolioViewController animated:YES];
