...
@interface OCRPageViewController ()
...
@implementation OCRPageViewController
...
- (void)viewDidLoad {
    ...
    OCRPageChildViewController *initialViewController = [self viewControllerAtIndex:0];
...
- (void) buildJSON {
    ...
    @try{
        ...
        {
            [CommonUtils showMessage:@"No image available, please upload from OCR":self];
            [NSThread detachNewThreadSelector:@selector(stopActivityIndicator) toTarget:self withObject:nil];
...
- (UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController {
    ...
    NSUInteger index = [(OCRPageChildViewController *)viewController index];
...
- (OCRPageChildViewController *)viewControllerAtIndex:(NSUInteger)index {
    ...
    OCRPageChildViewController *ocrPageChildViewController = [[OCRPageChildViewController alloc] init];
    ocrPageChildViewController.index = index;
    ocrPageChildViewController.refNo=self.refNo;
    ocrPageChildViewController.pageCount=[NSNumber numberWithInteger:[imageArray count]];
    
    imageData=[imageArray objectAtIndex:index];
    ocrPageChildViewController.imageFileName=imageData.imageFileName;
    ocrPageChildViewController.imageFileFolder=imageData.imageFileFolder;
    ocrPageChildViewController.imageId=imageData.imageId;
    ...
    return ocrPageChildViewController;
...
- (NSInteger)presentationIndexForPageViewController:(UIPageViewController *)pageViewController {
    ...
    return [(OCRPageChildViewController *)[pageViewController.viewControllers firstObject] index];
