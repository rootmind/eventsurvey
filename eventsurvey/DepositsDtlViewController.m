...
@interface DepositsDtlViewController ()
...
@implementation DepositsDtlViewController
...
@synthesize accounts;
@synthesize depositCaptionData;
@synthesize depositValueData;
...
- (void)viewDidLoad {
    ...
    //self.view.backgroundColor=[UIColor controllerBGColor];//[UIColor colorWithRed:62/255.0 green:173/255.0 blue:219/255.0 alpha:1.0];//[UIColor whiteColor];
     ...
     self.view.backgroundColor=[UIColor whiteColor];
        ...
        self.navigationItem.title=@"Deposits";
    ...
    //    UIImageView *companyLogo =[[UIImageView alloc] initWithFrame:CGRectMake(70,50,150,20)];
    //    companyLogo.image=[UIImage imageNamed:@"bank_logo.png"];
    ...
    tableTitle.text = @"Deposit Details";
    ...
    depositCaptionData = [[NSMutableArray alloc] init];
    depositValueData = [[NSMutableArray alloc] init];
    
    [depositCaptionData addObject:@"Deposit Amount"];
    [depositCaptionData addObject:@"Deposit Currency"];
    [depositCaptionData addObject:@"Deposit Tenor"];
    [depositCaptionData addObject:@"Deposit Date"];
    [depositCaptionData addObject:@"Deposit Maturity Date"];
    [depositCaptionData addObject:@"Deposit Renewal Type"];
    [depositCaptionData addObject:@"Deposit Credit Account"];
    [depositCaptionData addObject:@"Deposit Maturity Amount"];
    ...
    if(accountsArray.count >0)
    {
        ...
        [depositValueData addObject:[NSString stringWithFormat:@"%@",accounts.depositAmount]];
        [depositValueData addObject:[NSString stringWithFormat:@"%@",accounts.depositCurrency]];
        [depositValueData addObject:[NSString stringWithFormat:@"%@",accounts.depositTenor]];
        [depositValueData addObject:[NSString stringWithFormat:@"%@",accounts.depositDate]];
        [depositValueData addObject:[NSString stringWithFormat:@"%@",accounts.depositMaturityDate]];
        [depositValueData addObject:[NSString stringWithFormat:@"%@",accounts.depositRenewalType]];
        [depositValueData addObject:[NSString stringWithFormat:@"%@",accounts.depositCreditAccount]];
        [depositValueData addObject:[NSString stringWithFormat:@"%@",accounts.depositMaturityAmount]];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [depositCaptionData count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%@",[depositCaptionData objectAtIndex:indexPath.row]];
    cell.detailTextLabel.text=[NSString stringWithFormat:@"%@",[depositValueData objectAtIndex:indexPath.row]];
...
- (void) buildJSON {
    ...
    @try{
        ...
        [self parseResponse:newData:@"fetchDeposits":@"accountsWrapper"];
...
//        NSString *body =  [NSString stringWithFormat:@"userid=%@&sessionid=%@&methodAction=fetchDeposits&cifNumber=%@&accountNumber=%@",userid,sessionid,cifNumber,accountNumber];
//        
//        
    ...
    @try {
        ...
        if (jsonObject != nil && error == nil){
            ...
            if([success boolValue] == YES){
                ...
                accountDataDictionary =[jsonObject objectForKey:@"fetchDeposits"];
...
- (void) displayHeader{
    ...
    if(accountsArray.count >0)
    {
        ...
        progress=@([accounts.depositAmount floatValue]/[accounts.depositAmount floatValue]);
    ...
    if(accountsArray.count >0)
    {
        lblcurrBal.text = [NSString stringWithFormat:@"Deposit Amount"];
    }
    ...
    if(accountsArray.count >0)
    {
        lblcurrBalValue.text = [NSString stringWithFormat:@"%@ %@",accounts.depositAmount,accounts.depositCurrency];
    }
    ...
    if(accountsArray.count >0)
    {
        lblavalBal.text = [NSString stringWithFormat:@"Deposit Maturity Amount"];
    }
    ...
    if(accountsArray.count >0)
    {
        lblavalBalValue.text = [NSString stringWithFormat:@"%@ %@",accounts.depositMaturityAmount,accounts.depositCurrency];
    }
