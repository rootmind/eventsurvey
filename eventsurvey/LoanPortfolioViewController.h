...
#ifndef LoanPortfolioViewController_h
#define LoanPortfolioViewController_h


#endif /* LoanPortfolioViewController_h */
...
@interface LoanPortfolioViewController : UIViewController  <UITableViewDelegate,UITableViewDataSource,UIWebViewDelegate,UISplitViewControllerDelegate,UINavigationControllerDelegate,  UIImagePickerControllerDelegate,UIPopoverPresentationControllerDelegate>
