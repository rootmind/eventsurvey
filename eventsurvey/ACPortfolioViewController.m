...
@interface ACPortfolioViewController ()
...
@implementation ACPortfolioViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title=@"Accounts Portfolio";
...
-(void)displayGraph
{
    ...
    NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"accounts" ofType:@"html" inDirectory:@"www"]];
