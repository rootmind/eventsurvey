//
//  LoansDtlViewController.m
//  finnoneprod
//
//  Created by Sai Kiran Gandham on 12/20/14.
//  Copyright (c) 2014 Sai Kiran Gandham. All rights reserved.
//

#import <UIKit/UIKit.h>
#import <QuartzCore/QuartzCore.h>
#import "LoansDtlViewController.h"
...
@interface LoansDtlViewController ()
...
@implementation LoansDtlViewController
...
@synthesize accounts;
@synthesize loanCaptionData;
@synthesize loanValueData;
...
- (void)viewDidLoad {
    ...
    //self.view.backgroundColor=[UIColor colorWithRed:62/255.0 green:173/255.0 blue:219/255.0 alpha:1.0];//[UIColor whiteColor];
...
//    self.navigationItem.titleView=companyLogo;
    ...
    tableView.backgroundColor = [UIColor whiteColor];//[UIColor groupTableViewBackgroundColor];//[UIColor whiteColor];
    ...
    loanCaptionData = [[NSMutableArray alloc] init];
    loanValueData = [[NSMutableArray alloc] init];

    [loanCaptionData addObject:@"Loan Type"];
    [loanCaptionData addObject:@"Loan Desc"];
    [loanCaptionData addObject:@"Loan Status"];
    [loanCaptionData addObject:@"Princ Amount"];
    [loanCaptionData addObject:@"Princ Currency"];
    [loanCaptionData addObject:@"Instal Amount"];
    [loanCaptionData addObject:@"Instal Currency"];
    [loanCaptionData addObject:@"Loan Curr Balance"];
    [loanCaptionData addObject:@"Loan OS Balance"];
    [loanCaptionData addObject:@"Paid Amount"];
    [loanCaptionData addObject:@"Pending Instl"];
    [loanCaptionData addObject:@"Last Paid Amt"];
    [loanCaptionData addObject:@"Total Instals"];
    [loanCaptionData addObject:@"Installments Paid"];
    ...
    if(accountsArray.count >0)
    {
        ...
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.loanType]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.loanDesc]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.loanStatus]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.principalAmount]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.principalCurrency]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.installmentAmount]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.installmentCurrency]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.loanCurrentBalance]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.loanOSBalance]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.paidAmount]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.noPendingInstl]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.lastPaidAmount]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.totalInstallments]];
        [loanValueData addObject:[NSString stringWithFormat:@"%@",accounts.installmentsPaid]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIFont *mySecondFont = [UIFont boldSystemFontOfSize:14.0f];//[ UIFont fontWithName: @"Arial" size: 12.0 ];
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%@",[loanCaptionData objectAtIndex:indexPath.row]];
    cell.detailTextLabel.text=[NSString stringWithFormat:@"%@",[loanValueData objectAtIndex:indexPath.row]];
...
- (void) buildJSON {
    ...
    @try{
        ...
        newData=[CommonUtils connectHost :@"fetchLoans" :jsonDictionary :self];
        [self parseResponse:newData:@"fetchLoans":@"accountsWrapper"];
    ...
    @try {
        ...
        if (jsonObject != nil && error == nil){
            ...
            if([success boolValue] == YES){
                ...
                accountDataDictionary =[jsonObject objectForKey:@"fetchLoans"];
...
//        NSString *body =  [NSString stringWithFormat:@"userid=%@&sessionid=%@&methodAction=fetchLoans&cifNumber=%@&accountNumber=%@",userid,sessionid,cifNumber,accountNumber];
//        
//        
...
- (void) displayHeader{
    ...
    if(accountsArray.count >0)
    {
        ...
        progress=@([accounts.loanOSBalance floatValue]/[accounts.principalAmount floatValue]);
    ...
    if(accountsArray.count >0)
    {
        lblcurrBal.text = [NSString stringWithFormat:@"Current Loan Balance"];
    }
    ...
    if(accountsArray.count >0)
    {
        lblcurrBalValue.text = [NSString stringWithFormat:@"%@ %@",accounts.loanCurrentBalance,accounts.accountCurrency];
    }
    ...
    if(accountsArray.count >0)
    {
        lblavalBal.text = [NSString stringWithFormat:@"Loan OS Balance"];
    }
    ...
    if(accountsArray.count >0)
    {
        lblavalBalValue.text = [NSString stringWithFormat:@"%@ %@",accounts.loanOSBalance,accounts.accountCurrency];
    }
...
//    UILabel *redPer = [[UILabel alloc] initWithFrame:CGRectMake(0,0,progressView.progress*100,2)];
//    redPer.text=[[NSString alloc] initWithFormat:@"%f", progressView.progress*100];
//    redPer.font=[UIFont boldSystemFontOfSize:6];
//    redPer.textColor=[UIColor blackColor];
//    redPer.tintColor=[UIColor clearColor];
//    redPer.textAlignment=NSTextAlignmentCenter;
//    [progressView addSubview:redPer];
