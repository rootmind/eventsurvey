...
@interface LoanPortfolioViewController ()
...
@implementation LoanPortfolioViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title=@"Loans Portfolio";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LoansDtlViewController *loansDtlViewController = [[LoansDtlViewController alloc]initWithNibName:nil bundle:nil];
    loansDtlViewController.cifNumber=accountsData.cifNumber;
    loansDtlViewController.accountNumber=accountsData.accountNumber;
    ...
    [self.navigationController pushViewController:loansDtlViewController animated:YES];
...
- (void) buildJSON {
    ...
    @try{
        ...
        [self parseResponseFetchAccounts:newData:@"fetchLoans":@"accountsWrapper"];
