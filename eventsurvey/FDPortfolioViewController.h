...
#ifndef FDPortfolioViewController_h
#define FDPortfolioViewController_h


#endif /* FDPortfolioViewController_h */
...
@interface FDPortfolioViewController : UIViewController  <UITableViewDelegate,UITableViewDataSource,UIWebViewDelegate,UISplitViewControllerDelegate,UINavigationControllerDelegate,  UIImagePickerControllerDelegate,UIPopoverPresentationControllerDelegate>
