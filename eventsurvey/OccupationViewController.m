...
CGFloat lblConstraintOccX2=0.52f;
CGFloat lblConstraintOccY2=1.0f;
CGFloat lblConstraintWidthOcc2=0.5f;
CGFloat lblConstraintHeightOcc2=0.8f;

CGFloat constraintOccX2=1.19f;
CGFloat constraintOccY2=1.0f;
CGFloat constraintWidthOcc2=0.80f;
CGFloat constraintHeightOcc2=0.8f;

CGFloat constraint1OccX2=0.69f;
CGFloat constraint1OccY2=1.0f;
CGFloat constraint1WidthOcc2=0.3f;
CGFloat constraint1HeightOcc2=0.8f;

CGFloat lblConstraintOcc2X2=1.52f;
CGFloat lblConstraintOcc2Y2=1.0f;
CGFloat lblConstraintOcc2Width2=0.5f;
CGFloat lblConstraintOcc2Height2=0.8f;

CGFloat constraintOcc2X2=1.69f;
CGFloat constraintOcc2Y2=1.0f;
CGFloat constraintOcc2Width2=0.3f;
CGFloat constraintOcc2Height2=0.8f;
...
@synthesize txtOccupationType;
@synthesize txtOccupation;
@synthesize txtDesignation;
@synthesize txtNameOforganization;
@synthesize txtDateOfJoining;
@synthesize txtMonthlySalary;
@synthesize txtEmployeNo;
...
//    [self.splitViewController.displayModeButtonItem action];
   ...
   //self.navigationItem.title=[NSString stringWithFormat:@"%@ - %@",self.menuName,@"Occupation Details"];
    self.navigationItem.title=@"Occupation Details";
    ...
    //--when not new
    if([actionMode isEqualToString:@"UPDATE"] ||[actionMode isEqualToString:@"ENQUIRY"] || ([actionMode isEqualToString:@"NEW"] && [existingCustomerFlag isEqualToString:@"Y"] && [[[NSUserDefaults standardUserDefaults] stringForKey:@"userGroup"] isEqualToString:@"MAKER"]))
    // && [viewMode isEqualToString:@"Y"])
    {
...
-(BOOL) textFieldShouldBeginEditing:(UITextField *)textField
{
    ...
    //NSLog(@"fieldTag %ld", (long)textField.tag);
        ...
        if(textField.tag==1)
        {
            [self popoverData:textField:@"OccupationType"];
            return NO; //to disable keyboard
        }
         //--occupation
        else if(textField.tag==2)
        {
            [self popoverData:textField:@"Occupation"];
            return NO; //to disable keyboard
        }
        //--date of joining
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        if(indexPath.section==0)
        {
            ...
            CommonLabel *lblOccupationType=[[CommonLabel alloc]initWithFrame:CGRectZero];
            lblOccupationType.text=@"Occupation Type";
            lblOccupationType.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:lblOccupationType];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblOccupationType attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:lblConstraintOccX2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblOccupationType attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:lblConstraintOccY2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblOccupationType attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:lblConstraintWidthOcc2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblOccupationType attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:lblConstraintHeightOcc2 constant:0]];
            
            
            
            txtOccupationType = [[CommonTextField alloc] init];
            txtOccupationType.tag=1;
            txtOccupationType.delegate=self;
            txtOccupationType.placeholder=@"Occupation Type";
            txtOccupationType.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:txtOccupationType];
            
          
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtOccupationType attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:constraint1OccX2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtOccupationType attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:constraint1OccY2 constant:0]];
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtOccupationType attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:constraint1WidthOcc2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtOccupationType attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:constraint1HeightOcc2 constant:0]];
            
            
           
            
            CommonLabel *lblOccupation=[[CommonLabel alloc]initWithFrame:CGRectZero];
            lblOccupation.text=@"Occupation";
            lblOccupation.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:lblOccupation];

            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblOccupation attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:lblConstraintOcc2X2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblOccupation attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:lblConstraintOcc2Y2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblOccupation attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:lblConstraintOcc2Width2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblOccupation attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:lblConstraintOcc2Height2 constant:0]];
            
            
            
            txtOccupation = [[CommonTextField alloc] init];
            txtOccupation.tag=2;
            txtOccupation.delegate=self;
            txtOccupation.placeholder=@"Occupation";
            txtOccupation.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:txtOccupation];
            
            
    
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtOccupation attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:constraintOcc2X2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtOccupation attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:constraintOcc2Y2 constant:0]];
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtOccupation attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:constraintOcc2Width2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtOccupation attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:constraintOcc2Height2 constant:0]];
        ...
        else if(indexPath.section==1)
        {
            ...
            CommonLabel *lblDesignation=[[CommonLabel alloc]initWithFrame:CGRectZero];
            lblDesignation.text=@"Designation";
            lblDesignation.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:lblDesignation];
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblDesignation attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:lblConstraintOccX2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblDesignation attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:lblConstraintOccY2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblDesignation attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:lblConstraintWidthOcc2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblDesignation attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:lblConstraintHeightOcc2 constant:0]];
            
            
            
            txtDesignation = [[CommonTextField alloc] init];
            txtDesignation.tag=3;
            ...
            [cell.contentView addSubview:txtDesignation];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtDesignation attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:constraint1OccX2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtDesignation attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:constraint1OccY2 constant:0]];
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtDesignation attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:constraint1WidthOcc2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtDesignation attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:constraint1HeightOcc2 constant:0]];
            
            
            
            CommonLabel *lblNameOfOrganization=[[CommonLabel alloc]initWithFrame:CGRectZero];
            lblNameOfOrganization.text=@"Name Of Org";
            lblNameOfOrganization.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:lblNameOfOrganization];
        
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblNameOfOrganization attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:lblConstraintOcc2X2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblNameOfOrganization attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:lblConstraintOcc2Y2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblNameOfOrganization attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:lblConstraintOcc2Width2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblNameOfOrganization attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:lblConstraintOcc2Height2 constant:0]];
            
            
            
            txtNameOforganization=[[CommonTextField alloc] initWithFrame:CGRectZero];
            txtNameOforganization.tag=4;
            txtNameOforganization.delegate=self;
            txtNameOforganization.placeholder=@"Name Of Organization";
            txtNameOforganization.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:txtNameOforganization];
            
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtNameOforganization attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:constraintOcc2X2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtNameOforganization attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:constraintOcc2Y2 constant:0]];
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtNameOforganization attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:constraintOcc2Width2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtNameOforganization attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:constraintOcc2Height2 constant:0]];
            
            
        }
        else if(indexPath.section==2){
            
            CommonLabel *lblDateOfJoining=[[CommonLabel alloc]initWithFrame:CGRectZero];
            lblDateOfJoining.text=@"Date Of Joining";
            lblDateOfJoining.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:lblDateOfJoining];
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblDateOfJoining attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:lblConstraintOccX2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblDateOfJoining attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:lblConstraintOccY2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblDateOfJoining attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:lblConstraintWidthOcc2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblDateOfJoining attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:lblConstraintHeightOcc2 constant:0]];
            
            
           
            txtDateOfJoining=[[CommonTextField alloc] initWithFrame:CGRectZero];
            txtDateOfJoining.tag=5;
            txtDateOfJoining.delegate=self;
            txtDateOfJoining.placeholder=@"Date Of Joining";
            txtDateOfJoining.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:txtDateOfJoining];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtDateOfJoining attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:constraint1OccX2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtDateOfJoining attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:constraint1OccY2 constant:0]];
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtDateOfJoining attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:constraint1WidthOcc2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtDateOfJoining attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:constraint1HeightOcc2 constant:0]];
            
           
            
            CommonLabel *lblMonthlySalary=[[CommonLabel alloc]initWithFrame:CGRectZero];
            lblMonthlySalary.text=@"Monthly Salary";
            lblMonthlySalary.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:lblMonthlySalary];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblMonthlySalary attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:lblConstraintOcc2X2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblMonthlySalary attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:lblConstraintOcc2Y2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblMonthlySalary attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:lblConstraintOcc2Width2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblMonthlySalary attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:lblConstraintOcc2Height2 constant:0]];
            
            
            txtMonthlySalary=[[CommonTextField alloc] initWithFrame:CGRectZero];
            txtMonthlySalary.tag=6;
            txtMonthlySalary.delegate=self;
            txtMonthlySalary.placeholder=@"Monthly Salary";
            txtMonthlySalary.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:txtMonthlySalary];
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtMonthlySalary attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:constraintOcc2X2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtMonthlySalary attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:constraintOcc2Y2 constant:0]];
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtMonthlySalary attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:constraintOcc2Width2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtMonthlySalary attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:constraintOcc2Height2 constant:0]];
            
            
        }
        else if(indexPath.section==3){
            
            CommonLabel *lblEmployeeNo=[[CommonLabel alloc]initWithFrame:CGRectZero];
            lblEmployeeNo.text=@"Employee No";
            lblEmployeeNo.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:lblEmployeeNo];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblEmployeeNo attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:lblConstraintOccX2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblEmployeeNo attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:lblConstraintOccY2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblEmployeeNo attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:lblConstraintWidthOcc2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:lblEmployeeNo attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:lblConstraintHeightOcc2 constant:0]];
            
            
         
            txtEmployeNo = [[CommonTextField alloc] init];
            txtEmployeNo.tag=7;
            txtEmployeNo.delegate=self;
            txtEmployeNo.placeholder=@"Employee No";
            txtEmployeNo.translatesAutoresizingMaskIntoConstraints=NO;
            [cell.contentView addSubview:txtEmployeNo];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtEmployeNo attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterX multiplier:constraint1OccX2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtEmployeNo attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeCenterY multiplier:constraint1OccY2 constant:0]];
            
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtEmployeNo attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeWidth multiplier:constraint1WidthOcc2 constant:0]];
            
            [cell addConstraint:[NSLayoutConstraint constraintWithItem:txtEmployeNo attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:cell.contentView attribute:NSLayoutAttributeHeight multiplier:constraint1HeightOcc2 constant:0]];
    ...
    if(([actionMode isEqualToString:@"UPDATE"] || [actionMode isEqualToString:@"ENQUIRY"]) && [occupationArray count]>0)
    {
        [self loadData];
    }
...
//    if (row != NSNotFound)
//    {
//        occupationData = [occupationArray objectAtIndex:0];
//        
//       
//        
...
- (void) doValidate {
        ...
        if([CommonUtils checkEmptyString:txtOccupationType.text]==YES)
        {
    
            [CommonUtils showMessage:@"Occupation Type can't be blank":self];
            [NSThread detachNewThreadSelector:@selector(stopActivityIndicator) toTarget:self withObject:nil];
    
            return;
    
        }
        if([CommonUtils checkEmptyString:txtOccupation.text]==YES)
        {
    
            [CommonUtils showMessage:@"Occupation can't be blank":self];
            [NSThread detachNewThreadSelector:@selector(stopActivityIndicator) toTarget:self withObject:nil];
        ...
        if([CommonUtils checkEmptyString:txtNameOforganization.text]==YES)
        {
    
            [CommonUtils showMessage:@"Name Of Oganization can't be blank":self];
            [NSThread detachNewThreadSelector:@selector(stopActivityIndicator) toTarget:self withObject:nil];
    
            return;
    
        }
        if([CommonUtils checkEmptyString:txtDateOfJoining.text]==YES)
        {
    
            [CommonUtils showMessage:@"Date Of Joining can't be blank":self];
            [NSThread detachNewThreadSelector:@selector(stopActivityIndicator) toTarget:self withObject:nil];
    
            return;
    
        }
        if([CommonUtils checkEmptyString:txtMonthlySalary.text]==YES)
        {
    
            [CommonUtils showMessage:@"Monthly Salary can't be blank":self];
            [NSThread detachNewThreadSelector:@selector(stopActivityIndicator) toTarget:self withObject:nil];
    
            return;
    
        }
        if([CommonUtils checkEmptyString:txtEmployeNo.text]==YES)
        {
            
            [CommonUtils showMessage:@"Employee No can't be blank":self];
            [NSThread detachNewThreadSelector:@selector(stopActivityIndicator) toTarget:self withObject:nil];
...
- (void) buildJSON {
        ...
        NSLog(@"Occupation action mode %@",actionMode);
        NSLog(@"Occupation Ref no %@",self.refNo);
...
//            {
                ...
                jsonDictionary= @{
                                  ...
                                  @"occupationType":emptyStringIfNil([popoverCodeValue valueForKey:[NSString stringWithFormat:@"%d",self.txtOccupationType.tag]]),
                                  @"occupation":emptyStringIfNil([popoverCodeValue valueForKey:[NSString stringWithFormat:@"%d",self.txtOccupation.tag]]),
                                  @"designation":emptyStringIfNil(self.txtDesignation.text),
                                  @"nameOfOrg":emptyStringIfNil(self.txtNameOforganization.text),
                                  @"doj":emptyStringIfNil(self.txtDateOfJoining.text),
                                  @"monthlySalary":emptyStringIfNil(self.txtMonthlySalary.text),
                                  @"employeeNo":emptyStringIfNil(self.txtEmployeNo.text),
...
//            {
                    ...
                    newData=[CommonUtils connectHost :@"updateOccupationDetails" :jsonDictionary :self];
                    [self parseResponse:newData:@"updateOccupationDetails":@"occupationDetailsWrapper"];
...
//            }
            ...
            contactViewController.recordStatus=self.recordStatus;
            //contactViewController.viewMode=self.viewMode;
            contactViewController.refNo=self.refNo;
            contactViewController.existingCustomerFlag=self.existingCustomerFlag;
            contactViewController.accountType=self.accountType;
            contactViewController.menuName=self.menuName;
...
- (void) viewData {
    ...
    @try{
            ...
            NSData * newData=[CommonUtils connectHost :@"fetchOccupationDetails" :jsonDictionary :self];
            [self parseResponse:newData:@"fetchOccupationDetails":@"occupationDetailsWrapper"];
    ...
    @catch (NSException *exception) {
        ...
        NSLog(@"Exception in Occupation viewData code %@ reason %@ " , [exception name], [exception reason]);
        [CommonUtils showMessage:[exception reason] :self];
    ...
    @finally {
        ...
        NSLog(@"finally in Occupation fetch viewData Code");
...
-(void) loadData {
    ...
    @try{
        ...
        txtOccupationType.text=emptyStringIfNil(occupationData.occupationTypeValue);
        txtOccupation.text=emptyStringIfNil(occupationData.occupationValue);
        txtDesignation.text=emptyStringIfNil(occupationData.designation);
        txtNameOforganization.text=emptyStringIfNil(occupationData.nameOfOrg);
        txtDateOfJoining.text=emptyStringIfNil(occupationData.doj);
        txtMonthlySalary.text=[NSString stringWithFormat:@"%@",emptyStringIfNil(occupationData.monthlySalary)];
        txtEmployeNo.text=emptyStringIfNil(occupationData.employeeNo);
        ...
        if (jsonObject != nil && error == nil){
            ...
            if([success boolValue] == YES){
                ...
                // Create a new array to hold the locations
                    occupationArray = [[NSMutableArray alloc] init];
                ...
                for(NSDictionary *dict in array) {
                    ...
                    occupationData = [[OccupationData alloc] initWithJSONDictionary:dict];
                    
                    NSLog(@" occupationData %@",occupationData.designation);
                    
                    // Add the Location object to the array
                    [occupationArray addObject:occupationData];
                    
                }
                
                
                NSLog(@"data count %lu",(unsigned long)occupationArray.count);
