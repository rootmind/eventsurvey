...
@interface LoansDtlViewController : UIViewController <UITableViewDelegate,UITableViewDataSource>
...
@property (strong, nonatomic) NSMutableArray *loanCaptionData;
@property (strong, nonatomic) NSMutableArray *loanValueData;
